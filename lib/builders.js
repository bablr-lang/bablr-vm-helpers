...
export const buildFullyQualifiedSpamMatcher = (flags, language, type, value, attributes = {}) => {
...
export const buildDoctypeTag = (language) => {
  ...
  return t.node(
    l.CSTML,
    'DoctypeTag',
    [t.ref`open`, t.ref`doctype`, t.embedded(buildSpace()), t.ref`language`, t.ref`close`],
    {
      open: t.s_node(l.CSTML, 'Punctuator', '<!'),
...
export const buildString = (value) => {
  const value_ = isString(value) ? [value] : value;
        ...
        terminals.push(
          t.buildEmbedded(
            t.e_node(
              ...
              {
                escape: t.s_node(l.CSTML, 'Punctuator', '\\'),
                escapee: t.s_node(l.CSTML, 'Literal', chr),
              },
              chr !== 'g' ? { cooked: escapables.get(chr) } : {},
            ),
          ),
        );
      } else {
