...
export const buildReference = (pathName, pathIsArray) => {
  return t.node('CSTML', 'Reference', [t.ref`name`, ...when(pathIsArray, [t.ref`arrayOperator`]), t.ref`mapOperator`], {
...
export const buildNodeOpenTag = (flags, type, attributes) => {
  return t.node('CSTML', 'OpenNodeTag', [t.ref`open`, ...when(flags, [t.ref`flags`]), t.ref`type`, t.embedded(buildSpace()), ...interpolateArrayChildren(attributes, t.ref`attributes[]`, t.embedded(buildSpace())), t.ref`close`], {
...
export const buildNodeCloseTag = () => {
  return t.node('CSTML', 'CloseNodeTag', [t.ref`value`], {
    value: t.s_node('CSTML', 'Punctuator', '</>')
  });
};
export const buildFragmentCloseTag = () => {
  return t.node('CSTML', 'CloseFragmentTag', [t.ref`value`], {
    value: t.s_node('CSTML', 'Punctuator', '</>')
  });
};
