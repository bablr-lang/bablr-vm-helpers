...
export const buildNodeFlags = (flags = {}) => {
  ...
  return t.node('CSTML', 'NodeFlags', [...when(token, [t.ref`token`]), ...when(trivia, [t.ref`trivia`]), ...when(escape, [t.ref`escape`])], {
    token: token && t.s_node('CSTML', 'Punctuator', '*'),
...
export const buildNodeOpenTag = (flags, type, attributes = {}) => {
  ...
  return t.node('CSTML', 'OpenNodeTag', [t.ref`open`, ...when(flags_, [t.ref`flags`]), t.ref`type`, ...when(attributes_.length, [t.embedded(buildSpace())]), ...interpolateArrayChildren(attributes, t.ref`attributes[]`, t.embedded(buildSpace())), t.ref`close`], {
...
export const buildArray = elements => {
  return _t.node("Instruction", "Array", [_t.ref`open`, ..._interpolateArrayChildren(elements, _t.ref`elements[]`, _t.embedded(_t.t_node('Comment', null, [_t.embedded(_t.t_node('Space', 'Space', [_t.lit(' ')]))]))), _t.ref`close`], {
...
export const buildTuple = values => {
  return _t.node("Instruction", "Tuple", [_t.ref`open`, ..._interpolateArrayChildren(values, _t.ref`values[]`, _t.embedded(_t.t_node('Comment', null, [_t.embedded(_t.t_node('Space', 'Space', [_t.lit(' ')]))]))), _t.ref`close`], {
    open: _t.s_node("Instruction", "Punctuator", "("),
...
export const buildObject = properties => {
  return _t.node("Instruction", "Object", [_t.ref`open`, ..._interpolateArrayChildren(Object.entries(properties).map(([key, value]) => buildProperty(key, value)), _t.ref`properties[]`, _t.embedded(_t.t_node('Comment', null, [_t.embedded(_t.t_node('Space', 'Space', [_t.lit(' ')]))]))), _t.ref`close`], {
    open: _t.s_node("Instruction", "Punctuator", "{"),
