...
import { buildNodeCloseTag, buildLiteral } from './builders.js';
import { ref } from '@bablr/agast-helpers/shorthand';
...
export const buildChildren = (node) => {
  ...
  if (selfClosing) {
    built.push(open);
    if (intrinsicValue) built.push(buildLiteral(intrinsicValue));
